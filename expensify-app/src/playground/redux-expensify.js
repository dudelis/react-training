...
//Filters reducer
const defaultReducerFilterState={
    text: '',
    sortBy: 'date',
    startDate: undefined,
    endDate: undefined
...
const filterReducer = (state = defaultReducerFilterState, action) =>{
    switch(action.type){
...
const expense3 = store.dispatch(addExpense({description: 'Rent', amount: 400, createdAt: 500}));
